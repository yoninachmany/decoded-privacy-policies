...
with open('data/qc/sampleOutput/paragraphToLabel.csv') as csvfile:
    ...
    for row in reader:
        ...
        for question in questions:
            ...
            if response == "Yes":
                companyToQuestionsToResponsesMap[company][paragraph] = "Yes"
                companyToQuestionToYesParagraphMap[company][question] = paragraph

with open('data/aggregation/sampleOutput/companyQuestionResponsesAndYesParagraphs.csv', 'w') as csvfile:
